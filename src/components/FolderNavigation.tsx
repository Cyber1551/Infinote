...
interface IFolderNavigation {
    file: IFile;
    active: boolean;
}

const FolderNavigation = ({ file, active }: IFolderNavigation) => {
    ...
    const onShow = async (ev: MouseEvent<HTMLSpanElement>) => {
        ev.stopPropagation()
    ...
    return <div className="source-item">
        ...
        <FileNavigation visible={unfold} files={files} />
    </div>
}
